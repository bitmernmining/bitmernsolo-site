...
const MOCKUP_COINS = [
  ...
  { symbol: "DOGE", active: false },
  { symbol: "BCH", active: false },
  { symbol: "DGB", active: false },
  { symbol: "XEC", active: false },
  { symbol: "ETC", active: false },
  { symbol: "ZEC", active: false },
  { symbol: "XMR", active: false },
  { symbol: "RVN", active: false },
] as const;
              ...
              <div className="flex">
                <div className="hidden md:flex w-44 shrink-0 flex-col border-r border-border/30 bg-[oklch(0.13_0_0)]">
                  <div className="border-b border-[oklch(0.22_0_0)] p-3">
                    <Image src="/logo-light.svg" alt="Bitmern Pool" width={100} height={28} className="h-4 w-auto" />
                    <div className="mt-2 flex items-center justify-between rounded-md px-1.5 py-1">
                  ...
                  <div className="flex-1 p-2 space-y-0.5">
                    {[
                      ...
                      { label: "Pool Stats", icon: ICON.barChart },
                ...
                <div className="flex-1 p-3 sm:p-4 space-y-3 overflow-hidden">
                    ...
                    <div className="inline-flex flex-wrap items-center gap-0.5">
                      {MOCKUP_COINS.map((c) => (
                        <span
                          ...
                          className={
                            c.active
                              ? "flex items-center gap-1 rounded-md bg-background px-1.5 py-0.5 text-[8px] font-medium shadow-sm border border-border/40"
                              : "flex items-center gap-1 px-1 py-0.5 text-[8px] text-muted-foreground"
                          }
                        >
                          <Image
                            src={`/coins/${c.symbol.toLowerCase()}.svg`}
                            alt={c.symbol}
                            width={10}
                            height={10}
                  ...
                  <div className="rounded-lg border border-border/40 bg-card p-2.5">
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <span className="text-[8px] text-primary">24H</span>
                    </div>
                    <svg viewBox="0 0 500 70" className="w-full" preserveAspectRatio="none" role="img" aria-label="24-hour hashrate trend chart">
                      <defs>
                      ...
                      <path d="M0,40 C50,38 100,42 150,30 C200,20 250,28 300,18 C350,12 400,16 450,10 C475,8 490,9 500,8 L500,70 L0,70 Z" fill="url(#hcGrad)" />
                      <path d="M0,40 C50,38 100,42 150,30 C200,20 250,28 300,18 C350,12 400,16 450,10 C475,8 490,9 500,8" fill="none" stroke="oklch(0.795 0.153 78)" strokeWidth="1.5" />
                    </svg>
                  </div>
                </div>
              </div>
