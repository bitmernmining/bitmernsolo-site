...
export function Hero({ blocksFound }: HeroProps = {}) {
  return (
    <section className="relative overflow-hidden pb-0">
      ...
      <div className="relative mx-auto max-w-5xl px-4 sm:px-6 mt-16 sm:mt-20 mask-fade-bottom pb-10">
        <div className="rounded-xl border border-border/40 bg-card/50 p-6 text-center">
          ...
          <p className="mt-3 text-sm text-muted-foreground">
            Point your miner at our stratum and start submitting shares in minutes.
          </p>
        </div>
      </div>
    </section>
