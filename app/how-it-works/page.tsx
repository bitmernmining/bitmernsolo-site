...
export const metadata: Metadata = {
  ...
  description:
    "How Bitmern Solo works: connect your miner, submit shares, get paid when you find a block.",
};
    ...
    <div className="mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24">
      <div className="text-center mb-10">
        ...
        <p className="mt-3 mx-auto max-w-xl text-muted-foreground leading-relaxed">
          Solo mining with Bitmern: you keep the block reward minus a small pool
          fee. Detailed walkthrough is being restored.
        </p>
      </div>
